...
ROUTES=(
  ...
  "GET /admin/fundraisers/{id}"
  "POST /admin/fundraisers"
  "PATCH /admin/fundraisers/{id}"
  "POST /admin/fundraisers/{id}/begin"
  "POST /admin/fundraisers/{id}/stop"
)
...
aws lambda add-permission \
  ...
  --statement-id apigateway-admin-fundraisers-invoke \
  --action lambda:InvokeFunction \
  --principal apigateway.amazonaws.com \
  --source-arn "arn:aws:execute-api:${REGION}:${ACCOUNT_ID}:${API_ID}/*/*/admin/fundraisers*" \
