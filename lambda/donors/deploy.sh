...
ROLE_NAME="sixspur-donors-execution-role"
REGION="us-east-1"
PROFILE="sixspur"
...
rm -f donors.zip
zip -r donors.zip index.js dynamo.js node_modules package.json
