...
for ROUTE in "GET /farm-animals" "GET /farm-animals/{id}"; do
...
aws lambda add-permission \
  ...
  --statement-id apigateway-farm-animals-invoke \
  --action lambda:InvokeFunction \
  --principal apigateway.amazonaws.com \
  --source-arn "arn:aws:execute-api:${REGION}:${ACCOUNT_ID}:${API_ID}/*/*/farm-animals*" \
