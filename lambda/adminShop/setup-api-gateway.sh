...
ROUTES=(
  ...
  "POST /admin/shop/{id}/photos/presign"
  "POST /admin/shop/{id}/photos"
  "DELETE /admin/shop/{id}/photos"
  "PATCH /admin/shop/{id}/thumbnail"
)
...
aws lambda add-permission \
  ...
  --statement-id apigateway-admin-shop-invoke \
  --action lambda:InvokeFunction \
  --principal apigateway.amazonaws.com \
  --source-arn "arn:aws:execute-api:${REGION}:${ACCOUNT_ID}:${API_ID}/*/*/admin/shop*" \
