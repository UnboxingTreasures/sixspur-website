// s3.js
// Photo storage in the same sixspurranch-assets bucket + CloudFront
// distribution as everything else, under images/shop/.
...
async function createPresignedUploadUrl(itemId, fileName) {
  const safeName = fileName.replace(/[^a-zA-Z0-9.\-_]/g, '_');
  const key = `images/shop/${itemId}-${randomUUID()}-${safeName}`;
