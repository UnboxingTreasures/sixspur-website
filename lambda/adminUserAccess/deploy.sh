...
ROLE_NAME="sixspur-adminUserAccess-execution-role"
REGION="us-east-1"
PROFILE="sixspur"
...
rm -f adminUserAccess.zip
zip -r adminUserAccess.zip index.js dynamo.js adminAuth.js node_modules package.json
