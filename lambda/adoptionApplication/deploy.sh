...
ENV_VARS="Variables={CONTACT_MESSAGES_TABLE=contact_messages,ADOPTION_PDF_BUCKET=sixspurranch-adoption-pdfs,ADOPTION_UPLOADS_BUCKET=sixspurranch-adoption-uploads,SES_NOREPLY_ADDRESS=noreply@sixspurranch.org,SES_ADMIN_ADDRESS=richard@sixspurranch.org,RICHARD_PHONE_NUMBER=+18137866333}"
