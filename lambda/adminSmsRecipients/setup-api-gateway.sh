...
FUNCTION_NAME="sixspur-adminSmsRecipients"
AUTHORIZER_ID="gyxmij"
...
ROUTES=(
  ...
  "POST /admin/sms-recipients"
  "POST /admin/sms-recipients/verify"
...
aws lambda add-permission \
  ...
  --statement-id apigateway-admin-sms-recipients-invoke \
  --action lambda:InvokeFunction \
  --principal apigateway.amazonaws.com \
  --source-arn "arn:aws:execute-api:${REGION}:${ACCOUNT_ID}:${API_ID}/*/*/admin/sms-recipients*" \
