  ...
  return (
    <>
      <style>{`
        ...
        /* The real mobile bug: logo text + all 4 icons + the hamburger
           toggle were all flexShrink:0, so on a narrow phone their
           combined width genuinely exceeded the viewport -- nothing was
           overlapping, the row itself was just wider than the screen,
           which pushed the icons/toggle off the right edge and forced
           the whole page into horizontal scroll. Fix: let the logo text
           block shrink and truncate, and tighten padding/gaps, so
           everything actually fits in one row again. */
      ...
      `}</style>
      <div style={{ background: '#E77A2D', overflow: 'hidden', position: 'relative', zIndex: 49, width: '100%', maxWidth: '100vw' }}>
        <div className="six-spur-marquee-track" style={{ flexShrink: 0 }}>
