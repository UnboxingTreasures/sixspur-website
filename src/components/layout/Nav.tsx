...
export default function Nav() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault()
    if (searchQuery.trim()) {
      // TODO Session 9: wire to search results page
      setSearchOpen(false)
      setSearchQuery('')
    }
  }
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem', height: '64px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem' }}>
          ...
          <Link href='/' style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none', flexShrink: 0 }}>
            ...
            <div style={{ lineHeight: '1.25' }}>
              <div style={{ color: '#111111', fontSize: '13px', fontWeight: 500 }}>Six Spur Ranch and Rescue</div>
              <div style={{ color: '#555555', fontSize: '11px' }}>Maud, Texas · 501(c)(3)</div>
            </div>
          </Link>
