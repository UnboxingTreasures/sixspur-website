...
export default function WaysToGivePage() {
  ...
  const handleDonate = () => {
    ...
    // TODO Session 4: wire to PayPal
    alert(`Proceeding to PayPal for $${activeAmount.toFixed(2)} ${frequency === "monthly" ? "/ month" : "one-time"}`);
  };
        ...
        <div className="max-w-xl mx-auto">
          ...
          >
            {activeAmount && activeAmount > 0
              ? `Donate $${activeAmount.toFixed(2)}${frequency === "monthly" ? " / Month" : ""}`
              : "Select an Amount"}
          </button>
